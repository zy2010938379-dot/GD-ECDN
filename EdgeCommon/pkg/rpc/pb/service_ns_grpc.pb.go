...
func (c *nSServiceClient) ComposeNSBoard(ctx context.Context, in *ComposeNSBoardRequest, opts ...grpc.CallOption) (*ComposeNSBoardResponse, error) {
	...
	err := c.cc.Invoke(ctx, NSService_ComposeNSBoard_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nSServiceClient) ComposeNSUserBoard(ctx context.Context, in *ComposeNSUserBoardRequest, opts ...grpc.CallOption) (*ComposeNSUserBoardResponse, error) {
	...
	err := c.cc.Invoke(ctx, NSService_ComposeNSUserBoard_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedNSServiceServer should be embedded to have
