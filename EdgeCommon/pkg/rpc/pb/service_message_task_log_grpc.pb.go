...
func (c *messageTaskLogServiceClient) CountMessageTaskLogs(ctx context.Context, in *CountMessageTaskLogsRequest, opts ...grpc.CallOption) (*RPCCountResponse, error) {
	...
	err := c.cc.Invoke(ctx, MessageTaskLogService_CountMessageTaskLogs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *messageTaskLogServiceClient) ListMessageTaskLogs(ctx context.Context, in *ListMessageTaskLogsRequest, opts ...grpc.CallOption) (*ListMessageTaskLogsResponse, error) {
	...
	err := c.cc.Invoke(ctx, MessageTaskLogService_ListMessageTaskLogs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedMessageTaskLogServiceServer should be embedded to have
...
func (UnimplementedMessageTaskLogServiceServer) testEmbeddedByValue() {}
...
func RegisterMessageTaskLogServiceServer(s grpc.ServiceRegistrar, srv MessageTaskLogServiceServer) {
	// If the following call pancis, it indicates UnimplementedMessageTaskLogServiceServer was
