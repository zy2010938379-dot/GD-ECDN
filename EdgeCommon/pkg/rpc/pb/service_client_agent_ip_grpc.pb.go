...
func (c *clientAgentIPServiceClient) CreateClientAgentIPs(ctx context.Context, in *CreateClientAgentIPsRequest, opts ...grpc.CallOption) (*RPCSuccess, error) {
	...
	out := new(RPCSuccess)
	err := c.cc.Invoke(ctx, ClientAgentIPService_CreateClientAgentIPs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clientAgentIPServiceClient) ListClientAgentIPsAfterId(ctx context.Context, in *ListClientAgentIPsAfterIdRequest, opts ...grpc.CallOption) (*ListClientAgentIPsAfterIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, ClientAgentIPService_ListClientAgentIPsAfterId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedClientAgentIPServiceServer should be embedded to have
