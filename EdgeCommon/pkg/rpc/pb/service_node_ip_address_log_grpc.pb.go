...
func (c *nodeIPAddressLogServiceClient) CountAllNodeIPAddressLogs(ctx context.Context, in *CountAllNodeIPAddressLogsRequest, opts ...grpc.CallOption) (*RPCCountResponse, error) {
	...
	err := c.cc.Invoke(ctx, NodeIPAddressLogService_CountAllNodeIPAddressLogs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nodeIPAddressLogServiceClient) ListNodeIPAddressLogs(ctx context.Context, in *ListNodeIPAddressLogsRequest, opts ...grpc.CallOption) (*ListNodeIPAddressLogsResponse, error) {
	...
	err := c.cc.Invoke(ctx, NodeIPAddressLogService_ListNodeIPAddressLogs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedNodeIPAddressLogServiceServer should be embedded to have
