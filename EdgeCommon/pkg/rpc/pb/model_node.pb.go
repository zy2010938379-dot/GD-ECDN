...
type Node struct {
	...
	BypassMobile           int32                  `protobuf:"varint,101,opt,name=bypassMobile,proto3" json:"bypassMobile,omitempty"`
...
func (x *Node) GetBypassMobile() int32 {
	if x != nil {
...
const file_models_model_node_proto_rawDesc = "" +
	...
	"nodeRegion\x12E\n" +
	"\x15secondaryNodeClusters\x18& \x03(\v2\x0f.pb.NodeClusterR\x15secondaryNodeClusters\x12\"\n" +
	"\fbypassMobile\x18e \x01(\x05R\fbypassMobile\"\xa0\x01\n" +
	"\tBasicNode\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x12\n" +
