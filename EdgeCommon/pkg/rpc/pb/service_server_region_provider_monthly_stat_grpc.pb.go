...
func (c *serverRegionProviderMonthlyStatServiceClient) FindTopServerRegionProviderMonthlyStats(ctx context.Context, in *FindTopServerRegionProviderMonthlyStatsRequest, opts ...grpc.CallOption) (*FindTopServerRegionProviderMonthlyStatsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ServerRegionProviderMonthlyStatService_FindTopServerRegionProviderMonthlyStats_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedServerRegionProviderMonthlyStatServiceServer should be embedded to have
