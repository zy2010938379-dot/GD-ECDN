...
func (c *aCMEAuthenticationServiceClient) FindACMEAuthenticationKeyWithToken(ctx context.Context, in *FindACMEAuthenticationKeyWithTokenRequest, opts ...grpc.CallOption) (*FindACMEAuthenticationKeyWithTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, ACMEAuthenticationService_FindACMEAuthenticationKeyWithToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedACMEAuthenticationServiceServer should be embedded to have
