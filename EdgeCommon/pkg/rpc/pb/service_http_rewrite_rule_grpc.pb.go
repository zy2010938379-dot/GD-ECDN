...
func (c *hTTPRewriteRuleServiceClient) CreateHTTPRewriteRule(ctx context.Context, in *CreateHTTPRewriteRuleRequest, opts ...grpc.CallOption) (*CreateHTTPRewriteRuleResponse, error) {
	...
	err := c.cc.Invoke(ctx, HTTPRewriteRuleService_CreateHTTPRewriteRule_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *hTTPRewriteRuleServiceClient) UpdateHTTPRewriteRule(ctx context.Context, in *UpdateHTTPRewriteRuleRequest, opts ...grpc.CallOption) (*RPCSuccess, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RPCSuccess)
	err := c.cc.Invoke(ctx, HTTPRewriteRuleService_UpdateHTTPRewriteRule_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedHTTPRewriteRuleServiceServer should be embedded to have
