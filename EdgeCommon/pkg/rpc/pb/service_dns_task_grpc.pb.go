...
func (c *dNSTaskServiceClient) ExistsDNSTasks(ctx context.Context, in *ExistsDNSTasksRequest, opts ...grpc.CallOption) (*ExistsDNSTasksResponse, error) {
	...
	err := c.cc.Invoke(ctx, DNSTaskService_ExistsDNSTasks_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dNSTaskServiceClient) FindAllDoingDNSTasks(ctx context.Context, in *FindAllDoingDNSTasksRequest, opts ...grpc.CallOption) (*FindAllDoingDNSTasksResponse, error) {
	...
	err := c.cc.Invoke(ctx, DNSTaskService_FindAllDoingDNSTasks_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dNSTaskServiceClient) DeleteDNSTask(ctx context.Context, in *DeleteDNSTaskRequest, opts ...grpc.CallOption) (*RPCSuccess, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RPCSuccess)
	err := c.cc.Invoke(ctx, DNSTaskService_DeleteDNSTask_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dNSTaskServiceClient) DeleteAllDNSTasks(ctx context.Context, in *DeleteAllDNSTasksRequest, opts ...grpc.CallOption) (*RPCSuccess, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RPCSuccess)
	err := c.cc.Invoke(ctx, DNSTaskService_DeleteAllDNSTasks_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedDNSTaskServiceServer should be embedded to have
