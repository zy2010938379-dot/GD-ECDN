...
func (this *CreatePopupAction) RunPost(params struct {
	...
	// CoreDNS
	ParamCoreDNSURL    string
	ParamCoreDNSAPIKey string
	...
	case "coredns":
		params.Must.
			Field("paramCoreDNSURL", params.ParamCoreDNSURL).
			Require("请输入CoreDNS API地址").
			Match("^(?i)(http|https):", "URL必须以http://或者https://开头")

		apiParams["url"] = params.ParamCoreDNSURL
		apiParams["apiKey"] = params.ParamCoreDNSAPIKey
	default:
